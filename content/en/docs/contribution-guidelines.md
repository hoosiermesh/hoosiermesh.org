...
[Hoosier Mesh repo](https://github.com/hoosiermesh/hoosiermesh.org). You can also
...
1. Fork the [Hoosier Mesh repo](https://github.com/hoosiermesh/hoosiermesh.org) on GitHub.
...
1. Follow the instructions in [Getting started](https://www.docsy.dev/docs/get-started/) to
...
1. Fork the [Hoosier Mesh repo](https://github.com/google/docsy-example) repo into
